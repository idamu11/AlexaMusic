...
LOG_GROUP_ID = int(getenv("-1002596140032", ""))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/jsjzjjsdj")

SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/dicegamegp11")
